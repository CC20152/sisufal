...
//de http://respostas.guj.com.br/30731-autocomplete-combobox-editavel-
//modificado por dayvson
...
public class AutoCompleteComboBoxListener<T> implements EventHandler<KeyEvent> {
    ...
    public AutoCompleteComboBoxListener(final ComboBox comboBox, String text) {
        this.comboBox = comboBox;
        sb = new StringBuilder();
        data = comboBox.getItems();

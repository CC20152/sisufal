...
public class PatrimonioPermanenteController implements Initializable {
    ...
    private void btnBuscar(ActionEvent event){
        ...
        if(this.cmbBloco.getValue() != null && !this.cmbBloco.getSelectionModel().isSelected(0)){
            patrimonio.getBloco().setId(Integer.parseInt((this.cmbBloco.getValue().toString().split("-"))[0]));
        }
        
        if(this.tableSala.getValue() != null && !this.tableSala.getSelectionModel().isSelected(0)){
            patrimonio.setSala(this.tableSala.getValue().toString());
        }
    ...
    private void btnSalvar(ActionEvent event) {
        ...
        patrimonio.setSala(this.tableSala.getValue());
    ...
    */
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        this.tableSala.getItems().add(g);
        this.tableSala.getItems().addAll(new SalaDAO().listAll());
